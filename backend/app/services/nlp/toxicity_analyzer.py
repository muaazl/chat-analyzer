...
class ToxicityAnalyzer:
    ...
    def __init__(self, model_name: str = settings.TOXICITY_MODEL):
        ...
        self._pipeline = None
        self.threshold = 0.5  # Confidence threshold for "High Risk"
    ...
    def analyze_chat(self, messages: List[RawMessage]) -> ToxicityAnalysisResponse:
        ...
        # Batched inference on unique texts
        ...
        # Build per-message results
        msg_results: List[MessageToxicity] = []
        # We need a lookup: message_index → scored dict
